    ...
    <header className="w-full bg-white shadow-sm border-b border-slate-200 z-50 sticky top-0">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3">
        <div className="flex items-center justify-between gap-4">
          ...
          {/* Prominent SIH 2026 Problem ID Badge */}
          <div className="flex items-center space-x-2">
            <div className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-slate-50 border border-slate-200/90 text-slate-800 shadow-2xs">
              <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />
              <span className="text-xs sm:text-sm font-extrabold text-[#003366] font-mono tracking-tight whitespace-nowrap">
                SIH 2026 Problem ID : 26036
              </span>
            </div>
            ...
            <button
              ...
              className="p-2 rounded-lg text-slate-700 hover:bg-slate-100 border border-slate-200 md:hidden"
