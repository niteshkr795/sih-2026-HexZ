    ...
    <header className="w-full bg-white shadow-sm border-b border-slate-200 z-50 sticky top-0">
      ...
      <nav className="bg-[#003366] text-white border-t border-[#002244] hidden md:block">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between text-xs font-semibold">
          ...
          {/* Login Button in Navigation Ribbon */}
          <div className="flex items-center space-x-2 py-1">
            <button
              onClick={() => onOpenLogin?.()}
              className="px-4 py-1.5 bg-[#FF9933] hover:bg-[#f08c28] text-slate-950 font-bold text-xs rounded-lg shadow-sm transition flex items-center gap-1.5 cursor-pointer"
            >
        ...
        <div className="md:hidden bg-slate-900 text-white border-t border-slate-800 p-4 space-y-3 animate-in slide-in-from-top-2">
          ...
          <div className="space-y-1 text-xs text-slate-300">
            ...
            <button
              ...
              className="w-full text-left p-2.5 mt-2 bg-[#FF9933] text-slate-950 rounded-lg font-bold flex items-center justify-between"
            >
